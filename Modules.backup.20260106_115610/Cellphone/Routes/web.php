...
Route::middleware(['web', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu'])->prefix('cellphone')->group(function() {
    ...
    // Activate/Deactivate
    Route::post('/mass-deactivate', 'CellphoneController@massDeactivate')->name('cellphone.mass-deactivate');
    Route::get('/activate/{id}', 'CellphoneController@activate')->name('cellphone.activate');
