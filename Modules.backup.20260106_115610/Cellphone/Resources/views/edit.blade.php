                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('imei', $cellphone->sku, ['class' => 'form-control', 'placeholder' => '123456789012345', 'required', 'maxlength' => '15', 'pattern' => '[0-9]{15}']) !!}
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('tax_type', ['exclusive' => __('product.exclusive'), 'inclusive' => __('product.inclusive')], null, ['class' => 'form-control select2', 'style' => 'width: 100%;']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <span class="help-block">Auto-calculated with tax</span>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number"
                                                           ...
                                                           min="0"
                                                           step="1">
                                                    <span class="help-block"><small>Leave empty for no changes</small></span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
