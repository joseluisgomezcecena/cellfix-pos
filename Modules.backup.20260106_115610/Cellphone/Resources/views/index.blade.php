                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                {!! Form::select('active_state', ['active' => 'Activo', 'inactive' => 'Inactivo', 'all' => 'Todos'], 'active', ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'active_state']) !!}
                            </div>
                        </div>
                            ...
                            <td colspan="8">
                                ...
                                <div style="display: flex; gap: 10px;">
                                    ...
                                    <button type="submit" class="btn btn-warning" id="deactivate-selected">
                                        <i class="fa fa-ban"></i> Desactivar Seleccionados
                                    </button>
                                    {!! Form::close() !!}
                                </div>
                                @endcan
    ...
    $(document).ready(function() {
        ...
        $('#mass_deactivate_form').on('submit', function(e) {
            ...
            if (selected.length === 0) {
                toastr.error('Por favor selecciona al menos un producto');
                return false;
            }
