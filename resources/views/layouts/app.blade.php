...
<body
    ...
    <div class="tw-flex thetop">
        ...
        <script src="{{ asset('js/fix-datatables.js') }}"></script> 
        {{-- Module JS --}}
...
#side-bar a[href$="/repair-orders/admin"],
...
#side-bar a[href$="/stock-bulk-adjust"],
...
#side-bar a[href$="/repair-orders/admin"]:hover,
...
#side-bar a[href$="/stock-bulk-adjust"]:hover,
