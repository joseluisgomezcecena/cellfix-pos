...
@section('javascript')
    ...
    {{-- Affiliate Discount Scripts --}}
    @if(isset($show_affiliate_discount) && $show_affiliate_discount)
        <script src="{{ asset('modules/affiliatediscount/js/affiliate-discount-modal.js') }}"></script>
        <script src="{{ asset('modules/affiliatediscount/js/affiliate-discount-calculator.js') }}"></script>
    @endif
