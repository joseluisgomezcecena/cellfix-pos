<div class="row pos_form_totals">
	<div class="col-md-12">
		<table class="table table-condensed">
			...
			<tr>
				<td colspan="4">
					<button type="button" class="btn btn-info btn-sm" id="promo_code_btn" data-toggle="modal" data-target="#promo_code_modal">
						<i class="fa fa-tag"></i> {{ __('promocode::lang.apply_promo_code') }}
					</button>
					<span id="promo_code_applied_label" class="label label-success" style="display: none; margin-left: 10px;">
						<i class="fa fa-check"></i> <span id="promo_code_company_name"></span>
					</span>
					<input type="hidden" name="promo_company_id" id="promo_company_id" value="">
					<input type="hidden" name="promo_total_discount" id="promo_total_discount" value="0">
				</td>
			</tr>
		</table>
	</div>
