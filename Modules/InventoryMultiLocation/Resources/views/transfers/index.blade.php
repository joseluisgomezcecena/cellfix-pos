                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control select2">
                                ...
                                <option value="pending" {{ request()->get('status') == 'pending' ? 'selected' : '' }}>{{ __('inventorymultilocation::lang.pending') }}</option>
                                <option value="in_transit" {{ request()->get('status') == 'in_transit' ? 'selected' : '' }}>{{ __('inventorymultilocation::lang.in_transit') }}</option>
                                <option value="completed" {{ request()->get('status') == 'completed' ? 'selected' : '' }}>{{ __('inventorymultilocation::lang.completed') }}</option>
                                <option value="cancelled" {{ request()->get('status') == 'cancelled' ? 'selected' : '' }}>{{ __('inventorymultilocation::lang.cancelled') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>{{ __('inventorymultilocation::lang.from_date') }}</label>
                            <input type="date" name="from_date" class="form-control" value="{{ request()->get('from_date') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>{{ __('inventorymultilocation::lang.to_date') }}</label>
