                    ...
                    <div class="modern-location-card location-card-{{ $cardStatus }}" data-location-id="{{ $location->id }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="stock-health-section">
                                <div class="health-label">
                                    <span>{{ __('inventorymultilocation::lang.stock_health') }}</span>
                            ...
                            <div class="stats-row primary-stats">
                                <div class="stat-item">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-label">{{ __('inventorymultilocation::lang.products_label') }}</div>
                                    </div>
                                </div>
                                <div class="stat-item">
                                    <div class="stat-icon">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-label">{{ __('inventorymultilocation::lang.total_value') }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="stats-row alert-stats">
                                <div class="alert-item {{ $lowStockCount > 0 ? 'alert-active' : '' }}">
                                    ...
                                    <div class="alert-content">
                                        ...
                                        <div class="alert-label">{{ __('inventorymultilocation::lang.low_stock_label') }}</div>
                                    </div>
                                </div>
                                <div class="alert-item {{ $outOfStockCount > 0 ? 'alert-active' : '' }}">
                                    ...
                                    <div class="alert-content">
                                        ...
                                        <div class="alert-label">{{ __('inventorymultilocation::lang.out_of_stock_label') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            <button class="view-inventory-btn" onclick="window.location.href='{{ route('inventory-multi.inventory') }}?location_id={{ $location->id }}'">
                                <i class="fa fa-eye"></i>
                                <span>{{ __('inventorymultilocation::lang.view_inventory') }}</span>
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('inventorymultilocation::lang.recent_activities')])
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>{{ __('inventorymultilocation::lang.reference_no') }}</th>
                            <th>{{ __('inventorymultilocation::lang.from') }}</th>
                            <th>{{ __('inventorymultilocation::lang.to') }}</th>
                            <th>{{ __('inventorymultilocation::lang.status') }}</th>
                            <th>{{ __('inventorymultilocation::lang.created_by') }}</th>
                            <th>{{ __('inventorymultilocation::lang.date') }}</th>
...
$(document).ready(function() {
    ...
    $('.view-inventory-btn').on('click', function(e) {
        ...
        $btn.html('<i class="fa fa-spinner fa-spin"></i> <span>{{ __('inventorymultilocation::lang.loading') }}</span>');
