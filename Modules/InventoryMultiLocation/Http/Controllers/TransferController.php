...
class TransferController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => __('inventorymultilocation::lang.invalid_transfer_request')
            ]);
    ...
    private function processSingleTransfer(Request $request, $business_id, $user_id)
    {
        ...
        if ($currentStock < $request->quantity) {
            return response()->json([
                'success' => false,
                'message' => __('inventorymultilocation::lang.insufficient_stock_available') . ' ' . $currentStock
            ]);
        }
        ...
        return response()->json([
            'success' => true,
            'message' => __('inventorymultilocation::lang.stock_transferred_success')
        ]);
    }
    ...
    private function processBulkTransfer(Request $request, $business_id, $user_id)
    {
        ...
        foreach ($request->items as $item) {
            ...
            if ($currentStock < $item['quantity']) {
                return response()->json([
                    'success' => false,
                    'message' => __('inventorymultilocation::lang.insufficient_stock_items')
                ]);
            }
        ...
        return response()->json([
            'success' => true,
            'message' => __('inventorymultilocation::lang.bulk_transfer_success')
        ]);
    }
    ...
    public function complete(Request $request, $id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => __('inventorymultilocation::lang.transfer_completed_success')
            ]);
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => __('inventorymultilocation::lang.transfer_cancelled_success')
            ]);
