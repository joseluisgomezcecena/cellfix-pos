@extends('layouts.app')
@section('title', 'Add Affiliated Business')

@section('content')

<!-- Content Header -->
<section class="content-header">
    <h1>Add Affiliated Business</h1>
</section>

<!-- Main content -->
<section class="content">
    {!! Form::open(['url' => route('affiliate-discounts.store'), 'method' => 'post']) !!}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <p class="help-block"><small>Only business-type contacts are shown</small></p>
                        </div>
                    </div>
